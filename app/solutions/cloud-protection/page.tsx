...
import { Cloud, Shield, Zap, Lock, Globe } from 'lucide-react'

const features = [
  {
    icon: Cloud,
    title: 'Seamless Cloud Integration',
    description: "Effortlessly secure your cloud assets with Zephyrn's advanced, frictionless integration."
  },
  {
    icon: Shield,
    title: 'End-to-End Encryption',
    description: "Your data is protected at every stage—at rest, in transit, and in use—using industry-leading encryption."
  },
  {
    icon: Zap,
    title: 'Real-Time Monitoring',
    description: "Instant alerts and continuous monitoring keep your cloud environment safe from emerging threats."
  },
  {
    icon: Lock,
    title: 'Zero Trust Architecture',
    description: "Every access request is verified, ensuring only authorized users and devices can interact with your cloud."
  },
  {
    icon: Globe,
    title: 'Global Compliance',
    description: "Stay ahead of regulations with automated compliance and audit-ready reporting for every region."
  }
]
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-extrabold mb-6 bg-gradient-to-r from-white via-blue-200 to-blue-500 bg-clip-text text-transparent drop-shadow-lg">
              Cloud Protection, Redefined
            </h1>
            <p className="text-xl text-white/70 max-w-2xl mx-auto">
              Zephyrn Securities redefines cloud security with seamless integration, real-time monitoring, and global compliance—empowering you to lead your industry with confidence.
            </p>
          </div>
          ...
          <div className="text-center">
            <p className="text-xl font-semibold text-blue-400 mb-8">
              Trust Zephyrn to secure your cloud, outpace threats, and lead your industry.
            </p>
            <a
              href="/contact-us"
